...
import net.cozystudios.cozystudioscore.block.entity.NetheriteTranquilLanternBlockEntity;
...
public class NetheriteTranquilLanternBlock extends BlockWithEntity {
    ...
    public NetheriteTranquilLanternBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new NetheriteTranquilLanternBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, net.cozystudios.cozystudioscore.block.entity.ModBlockEntities.NETHERITE_TRANQUIL_LANTERN, NetheriteTranquilLanternBlockEntity::tick);
    }
