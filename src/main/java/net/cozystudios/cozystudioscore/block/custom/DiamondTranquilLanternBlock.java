...
import net.cozystudios.cozystudioscore.block.entity.DiamondTranquilLanternBlockEntity;
...
public class DiamondTranquilLanternBlock extends BlockWithEntity {
    ...
    public DiamondTranquilLanternBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DiamondTranquilLanternBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, net.cozystudios.cozystudioscore.block.entity.ModBlockEntities.DIAMOND_TRANQUIL_LANTERN, DiamondTranquilLanternBlockEntity::tick);
    }
