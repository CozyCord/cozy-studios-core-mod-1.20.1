...
public class NetheriteTranquilLanternBlockEntity extends BlockEntity {

    public NetheriteTranquilLanternBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.NETHERITE_TRANQUIL_LANTERN, pos, state);
    }
